              ...
              {agents.map(agent => {
                ...
                return (
                  <div key={agent.id} className={styles.agentCard}>
                    ...
                    {alreadySent ? (
                      <div className={styles.sentTag}>✓ {alreadySent.status}</div>
                    ) : (
        ...
        {step === 'sent' && (
          <div className={styles.container}>
            <div className={styles.successBox}>
              ...
              <p>Your personalized query letter has been emailed to {activeAgent?.email}. They'll reply directly to your email address.</p>
            </div>
