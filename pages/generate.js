        ...
        {step === 'details' && (
          <div className={styles.container}>
            ...
            <div className={styles.form}>
              ...
              <div className={styles.field}>
                <label>Your credentials & platform <span>(optional)</span></label>
                <textarea rows={4} placeholder="e.g. Former journalist, 10k newsletter subscribers, TEDx speaker..." value={details.credentials}
            ...
            <div className={styles.proposalMain}>
              ...
              {PROPOSAL_SECTIONS.map(s => (
                <div
                  key={s.key}
                  id={s.key}
                  className={`${styles.section} ${activeSection === s.key ? styles.sectionActive : ''}`}
